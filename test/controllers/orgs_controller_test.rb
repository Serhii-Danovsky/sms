...
class OrgsControllerTest < ActionController::TestCase
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post :create, org: { address: @org.address, city: @org.city, creator: @org.creator, erdpou: @org.erdpou, name: @org.name, osoby: @org.osoby, phone: @org.phone }
    end
  ...
  test "should update org" do
    patch :update, id: @org, org: { address: @org.address, city: @org.city, creator: @org.creator, erdpou: @org.erdpou, name: @org.name, osoby: @org.osoby, phone: @org.phone }
    assert_redirected_to org_path(assigns(:org))
  end
